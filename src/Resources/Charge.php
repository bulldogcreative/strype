...
class Charge extends Resource implements ChargeInterface, RetrieveInterface, UpdateInterface, ListAllInterface
{
     ...
     * @param int               $amount    a positive integer representing how much to charge, in the smallest currency unit
     * @param array             $arguments any additional arguments you want to pass
     * @param string|null       $key       an idempotency key is a unique value generated by the client which the server uses to recognize subsequent retries of the same request
